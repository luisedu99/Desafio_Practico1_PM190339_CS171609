...
public class controladorUsuario {
    ...
    SQLiteDatabase sql;
    String bd = "UsuariosBD";
    String tabla = "create table if not exists usuario(id integer primary key autoincrement, usuario text, pass text, nombre text, apellido text)";
